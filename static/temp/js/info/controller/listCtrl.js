//文章列表。
infoApp.controller('listCtrl', ['$scope', '$http', '$state', 'utils', '$stateParams', '$location', '$modal', 'platformModalSvc', 'mobilePreviewSvc',
		function ($scope, $http, $state, utils, $stateParams, $location, $modal, platformModalSvc, mobilePreviewSvc) {
