//产品列表
productApp.controller('listCtrl', ['$scope', '$http', '$state',  'utils', '$stateParams','$location', '$modal' , function($scope,$http,$state,utils,$stateParams,$location,$modal) {
