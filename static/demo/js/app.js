var demoApp = angular.module('demoApp', ['platform', 'common', 'ng.webuploader', 'ui.tree', 'ng.ueditor', 'ui.bootstrap', 'ui.bootstrap.pagination', 'ui.nested.combobox', 'pageEditApp','toolApp']);
...
demoApp.config(['$stateProvider', '$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
	...
	$stateProvider.state('tree', {
		...
		.state('taglib', {
			...
			url: '/adselector',
			templateUrl: 'views/ad-selector.html',
			controller: 'adSelectorController'
		}).state('kindeditor', {
			url: '/kindeditor',
			templateUrl: 'views/kindeditor.html',
